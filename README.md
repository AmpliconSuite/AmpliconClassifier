...
See [docs/fan_primer.md](docs/fan_primer.md) for a primer on what FANs are, how they differ from ecDNA, and annotated examples from validation cell lines.
